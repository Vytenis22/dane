...
return [
    ...
    'Powered by {yii}' => '',
    'Showing <b>{begin, number}-{end, number}</b> of <b>{totalCount, number}</b> {totalCount, plural, one{item} other{items}}.' => 'Rodoma <b>{begin, number}-{end, number}</b> iš <b>{totalCount, number}</b> {totalCount, plural, one{elemento} other{elementų}}.',
    ...
    'The requested view "{name}" was not found.' => 'Ieškomas puslapis nerastas.',
    'The verification code is incorrect.' => 'Patvirtinimo kodas neteisingas.',
    ...
    '{attribute} cannot be blank.' => 'Laukelis negali būti tuščias.',
    ...
    '{attribute} should contain at least {min, number} {min, plural, one{character} other{characters}}.' => '{attribute} privalo sudaryti {min, number} {min, plural, one{simbolis} other{simbolių}}.',
